...
class GetPopularTvShowsUseCaseTest {
    ...
    private val useCase = GetPopularTvShowsUseCase(repository)
    ...
    fun `GIVEN popular movies when getPopularMovies is called then return mapped media items`() =
        runTest {
            ...
            every { repository.getPopularTvShow() } returns repositoryResponse
            val mockedMediaItem = mockMediaItemResponse.tvShowToMediaItem()
